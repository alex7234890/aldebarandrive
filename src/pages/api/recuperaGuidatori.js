    ...
    const decryptedGuidatori = guidatoriData.map((guidatore) => {
      try {
        return {
            ...
            auto_marca:decrypt(guidatore.auto_marca),
            auto_modello:decrypt(guidatore.auto_modello),
            auto_immatricolazione:decrypt(guidatore.auto_immatricolazione),
            auto_targa:decrypt(guidatore.auto_targa),
